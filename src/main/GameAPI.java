...
public abstract class GameAPI {
	...
	public static final GameWindow window = MainLoop.window;
	...
	public int getCursorX () {
		return (int) (MainLoop.getInputImage ().getCursorX () * window.getResolution () [0]);
	}
	...
	public int getCursorY () {
		return (int) (MainLoop.getInputImage ().getCursorY () * window.getResolution () [1]);
	}
